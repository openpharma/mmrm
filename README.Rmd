...
[![Code Coverage](https://raw.githubusercontent.com/openpharma/mmrm/_xml_coverage_reports/data/main/coverage.xml)](https://raw.githubusercontent.com/openpharma/mmrm/_xml_coverage_reports/data/main/badge.svg)
<!-- badges: end -->
\
...
* Individual-level random effects are not supported, the focus lies on marginal linear models.

**Main Features:**

* Flexible covariance specification:
  * [Structures](https://openpharma.github.io/mmrm/main/articles/covariance.html): unstructured, Toeplitz, AR1, compound symmetry, spatial exponential, and ante-dependence.
  * Groups: shared covariance structure for all subjects and, or group-specific
