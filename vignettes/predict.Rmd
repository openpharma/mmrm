...
variance-covariance matrix, with $\theta_{new}$ and the data used in fit. Then 
we simulate once with `simulate(method = "conditional", beta = beta_new, theta = theta_new)`.
