...
To simulation marginally, we take the variance of $\hat\theta$ and $\hat\beta$ into consideration.
...
For `simulate(method = "conditional")`, we use the estimated $\theta$ and $\beta$ to construct the $\mu$ and $A$ directly.
