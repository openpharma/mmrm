...
\[
  \frac{\partial{\Sigma_{ij}}}{\theta_2} = \sigma\frac{\partial{\rho^{d_{ij}}}}{\partial\theta_2} \\
...
\[
  ...
  = \frac{\partial{\sigma\rho^{d_{ij}-1}{d_{ij}}\rho(1-\rho)}}{\partial\theta_2}\\
  = \sigma\rho^{d_{ij}-2}{d_{ij}}\rho(1-\rho)((d_{ij}-1)\rho(1-\rho)+\rho(1-2\rho))
\]
