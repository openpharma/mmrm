...
Please note that, if we ignore $R_{hj}$, the second-order derivatives, we will get a different estimate of adjusted covariance matrix,
and we call it "Kenward-Roger-Linear".
...
While the Kenward-Roger adjusted covariance matrix is adopting Taylor series to approximate the true value, the choices
