...
that the DDF for the intercept term itself (when it is included) are calculated at the $G+1$ level, 
i.e. for the intercept we use $DDF_{G+1}$ degrees of freedom.
