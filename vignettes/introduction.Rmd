...
While this choice is not visible in the `print()` result of the fitted model 
...
matrix, see the
[vignette](https://openpharma.github.io/mmrm/main/articles/kenward.html#parameterization-methods-and-kenward-roger) 
for details.
