...
|mmrm           |  181.22|         179.51|         184.47|
|gls            |  374.90|         370.64|         395.70|
|glmmTMB        | 1364.69|        1361.70|        1375.51|
|lmer           | 1458.74|        1455.75|        1465.95|
...
```
#> [Errno 32] Datenübergabe unterbrochen (broken pipe)
#> Error in rel_diff(mmrm_ests): Objekt 'proc_mixed_ests' nicht gefunden
#> Error in eval(expr, envir, enclos): Objekt 'rel_diff_ests_tbl' nicht gefunden
```
...
```
#> Error in if (loc_frame && loc_frame <= nrow(parent_trace)) {: Fehlender Wert, wo TRUE/FALSE nötig ist
#> Error in if (loc_frame && loc_frame <= nrow(parent_trace)) {: Fehlender Wert, wo TRUE/FALSE nötig ist
#> Error in if (loc_frame && loc_frame <= nrow(parent_trace)) {: Fehlender Wert, wo TRUE/FALSE nötig ist
#> Error in if (loc_frame && loc_frame <= nrow(parent_trace)) {: Fehlender Wert, wo TRUE/FALSE nötig ist
#> Error in eval(expr, envir, enclos): Objekt 'cr_no_missing' nicht gefunden
#> Error in eval(expr, envir, enclos): Objekt 'cr_all' nicht gefunden
```
...
#> 
#> locale:
#>  [1] LC_CTYPE=de_DE.UTF-8       LC_NUMERIC=C               LC_TIME=de_CH.UTF-8        LC_COLLATE=de_DE.UTF-8    
#>  [5] LC_MONETARY=de_CH.UTF-8    LC_MESSAGES=de_DE.UTF-8    LC_PAPER=de_CH.UTF-8       LC_NAME=C                 
...
#>  [1] ggplot2_3.4.2           emmeans_1.8.7           sasr_0.1.2              glmmTMB_1.1.7          
#>  [5] nlme_3.1-163            lme4_1.1-34             Matrix_1.5-4.1          mmrm_0.3.0             
#>  [9] stringr_1.5.0           microbenchmark_1.4.10   purrr_1.0.1             dplyr_1.1.2            
#> [13] clusterGeneration_1.3.7 MASS_7.3-60             knitr_1.43             
#> 
#> loaded via a namespace (and not attached):
#>  [1] tidyr_1.3.0         utf8_1.2.3          generics_0.1.3      stringi_1.7.12      lattice_0.21-8     
#>  [6] magrittr_2.0.3      evaluate_0.21       grid_4.3.1          estimability_1.4.1  mvtnorm_1.2-2      
#> [11] rprojroot_2.0.3     jsonlite_1.8.7      backports_1.4.1     fansi_1.0.4         scales_1.2.1       
#> [16] numDeriv_2016.8-1.1 Rdpack_2.4          cli_3.6.1           rlang_1.1.1         rbibutils_2.2.13   
#> [21] munsell_0.5.0       splines_4.3.1       withr_2.5.0         pbkrtest_0.5.2      tools_4.3.1        
#> [26] parallel_4.3.1      nloptr_2.0.3        checkmate_2.2.0     coda_0.19-4         minqa_1.2.5        
#> [31] colorspace_2.1-0    here_1.0.1          boot_1.3-28         broom_1.0.5         reticulate_1.30    
#> [36] png_0.1-7           vctrs_0.6.3         R6_2.5.1            lifecycle_1.0.3     pkgconfig_2.0.3    
#> [41] gtable_0.3.3        pillar_1.9.0        glue_1.6.2          Rcpp_1.0.10         xfun_0.39          
#> [46] tibble_3.2.1        tidyselect_1.2.0    rstudioapi_0.14     xtable_1.8-4        TMB_1.9.4          
#> [51] compiler_4.3.1
```
