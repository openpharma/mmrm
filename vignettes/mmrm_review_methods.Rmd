...
|       Covariance structures       | mmrm::mmrm | SAS | nlme::gls | lme4::lmer | glmmTMB::glmmtmb |
|:---------------------------------:|:----------:|:---:|:---------:|:----------:|:----------------:|
|           Unstructured            |     X      |  X  |     X     |     X      |        X         |
|       Weighted Unstructured       |     X      |  X  |           |            |                  |
|     Toeplitz (heterogeneous)      |     X      |  X  |           |            |                  |
|      Toeplitz (homogeneous)       |     X      |  X  |           |            |                  |
|        Spatial exponential        |     X      |  X  |           |            |                  |
| Compound symmetry (heterogeneous) |     X      |  X  |     X     |            |                  |
|  Compound symmetry (homogeneous)  |     X      |  X  |           |            |                  |
|  Auto-regressive (heterogeneous)  |     X      |  X  |     X     |            |                  |
|   Auto-regressive (homogeneous)   |     X      |  X  |           |            |                  |
...
### mmrm
<pre><code>mmrm::mmrm(formula = FEV1 ~ <b>ad(VISITN | USUBJID)</b>, 
  data = fev_data, reml = FALSE)
</code></pre>
