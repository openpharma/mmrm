...
\[
  B_1 = L_i^\top (I - L_i X_i (X^\top W X)^{-1} X_i^\top L_i^\top)^{-1/2} L_i
\]
and

\[
  B_2 = W_i^\top (I - X_i (X^\top W X)^{-1} X_i^\top W_i)^{-1/2}
\]

and we also have

\[
  B_1 W_i^{-1} B_1 = L_i^\top (I - L_i X_i (X^\top W X)^{-1} X_i^\top L_i^\top )^{-1} L_i
\]
\[
  B_2 W_i^{-1} B_2 = W_i^\top (I - X_i (X^\top W X)^{-1} X_i^\top W_i)^{-1}
\]

but we can't get a direct $B_1 = B_2$
