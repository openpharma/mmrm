...
The `mmrm` package supports a wide range of correlation structures and also makes use of the decomposition<!-- add link / note: differences in notation -->.
...
See 
@Cnaan1997 for a tutorial,

@Mallinckrodt2008 for a review.
...
* Contrast to GEE models (incl. assumption on missingness)
* Further reading
-->
