...
\]
where the $\Delta_i$ are positive-definite matrices parameterized by a fixed, generally small set of parameters. As in the basic model, the within-group errors $\epsilon_i$ are assumed to be independent for different $i$ and independent of the random effects $b_i$.
