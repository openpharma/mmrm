...
MMRMs are introduced as an extension to basic linear mixed-effects model.
They are also contrasted to other types of statistical models for longitudinal data, such as linear mixed effects models with random intercepts and/or slopes) and models based on generalized estimating equations (GEEs). 
...
The `mmrm` package supports a wide range of correlation


<!-- TO DO: Below we describe variance and correlation function structures to represent the two components. -->
