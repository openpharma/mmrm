...
We follow the following logic(cpp code in `pseudoInverseSqrt`) to obtain the pseudo inverse:
...
In `Eigen` package, the pseudo inverse method is already implemented in `Eigen::CompleteOrthogonalDecomposition< MatrixType_ >::pseudoInverse	`,
