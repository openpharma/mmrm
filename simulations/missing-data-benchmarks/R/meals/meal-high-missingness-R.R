################################################################################
# Simulation with High Levels of Missingness
################################################################################
...
plan(
  batchtools_lsf,
  workers = 100,
  resources = list(memory = 10000, walltime = 3 * 60 * 60) # queue = "short",
)

# create the experiment
experiment <- create_experiment(
  name = "mmrm-benchmark-high-missingness-n-600-R",
  save_dir = "results/high-miss/n-600-R",
...
# hostname <- "sabanesd-kjii4i-eu.ocean"
