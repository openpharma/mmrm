...
In SAS result, the covariance matrix and degree of freedom are provided.
The method for degree of freedom is "between within"
...
So in `mmrm`, the method, stands for both "covariance adjust" and "degree of freedom calculation".
...
Of course, we will not have the option to combine the between within degree of freedom + traditional covariance matrix.
