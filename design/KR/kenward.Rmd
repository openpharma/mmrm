...
The hypothesis testing is still the same and is similar to the Satterthwaite method. We can still follow the same calculations as for the multi-dimensional case.
