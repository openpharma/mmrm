...
res1 <- mmrm:::test2(fit$tmb_data$x_matrix, fit$tmb_data$subject_zero_inds, fit$tmb_data$visits_zero_inds,
...
do.call(rbind,p_sparse)  - res1$P

do.call(rbind,unlist(q_sparse))  - res1$Q

do.call(rbind,unlist(r_sparse))  - res1$R
