...
that when requested. We start a separate file `TMB_mmrm2.cpp` for that.
...
tmb_cov_object$report(unlist(tmb_parameters))
tmb_cov_object$report(c(tmb_parameters$beta, tmb_fit$par))

# ls(tmb_cov_object$env)
# tmb_cov_object$parameters
# tmb_cov_object$fn(unlist(tmb_parameters))
# tmb_cov_object$report(tmb_cov_object$par)
#
# tmb_cov_object$par
# tmb_cov_object$gr(tmb_cov_object$par)
# sdreport(tmb_cov_object, getJointPrecision = TRUE)
```
