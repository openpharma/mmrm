...
- **Kevin Kunzmann**. Author.

- **Brian Matthew Lang**. Author.

- **Christian Stock**. Author.

- **Ya Wang**. Author.

- **Craig Gower-Page**. Contributor.

- **Dan James**. Author.

- **Jonathan Sidi**. Author.

- **Daniel Leibovitz**. Author.

- **Daniel D. Sjoberg**. Author.
  [](https://orcid.org/0000-0003-0862-2018)

- **Nikolas Ivan Krieger**. Author.
...
Source:
[`DESCRIPTION`](https://github.com/openpharma/mmrm/blob/v0.3.17/DESCRIPTION)
...
*mmrm: Mixed Models for Repeated Measures*. R package version 0.3.17,
