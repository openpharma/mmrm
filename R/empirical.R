...
#' - `g_mat`: `matrix` to calculate Satterthwaite degrees of freedom. (This element used to be `df_mat`, which was equivalent to `crossproduct(g_mat)`, but executing the cross product was a costly matrix manipulation that was being performed without the guarantee that the element would ever be needed.)
#'
#' @keywords internal
