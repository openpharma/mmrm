...
#' @param cov (`string`)\cr coefficients covariance matrix adjustment method.
...
#' The `method` and `cov` arguments specify the coefficients covariance matrix and degrees of freedom adjustments.
