...
mmrm_control <- function(n_cores = 1L,
  ...
  assert_subset(
    vcov,
    c("Asymptotic", "Empirical", "Empirical-Jackknife", "Empirical-BRL", "Kenward-Roger", "Kenward-Roger-Linear")
  )
...
mmrm <- function(formula,
  ...
  } else if (control$vcov %in% c("Empirical", "Empirical-Jackknife", "Empirical-BRL")) {
